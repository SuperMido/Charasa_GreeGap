                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="bd-example">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-12"><?=$source["sourcename"];?></dd>
                                            <dt class="col-sm-12">Item description:</dt>
                                            <dd class="col-sm-12"><?=$source["sourcedes"];?></dd>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="./index.php?controller=source&action=approve&id=<?=$source["id"];?>"><button type="button" class="btn btn-primary">
                                            Approve
                                        </button></a>
                                </div>
                            </div>
