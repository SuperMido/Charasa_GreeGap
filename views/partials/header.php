  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="assets/img/brand/fullicon.png" width="120" height="40" alt="GreeGAP Logo">
        <img class="navbar-brand-minimized" src="assets/img/brand/icon.png" width="30" height="30" alt="GreeGAP Logo">
      </a>
